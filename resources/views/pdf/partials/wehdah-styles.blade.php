<style>
    ...
    /* ------- Header (full + compact) ------- */
    .wehdah-header { background: #1a3a5c; color: #ffffff; padding: 10px 14px; margin-bottom: 10px; }
    ...
    .wehdah-header-logo-fallback { width: 50px; height: 50px; background: #ffffff; color: #1a3a5c; font-weight: bold; font-size: 18pt; text-align: center; line-height: 50px; border-radius: 4px; }
    ...
    .wehdah-customer-label { font-size: 9pt; font-weight: bold; color: #1a3a5c; margin-bottom: 4px; }
    ...
    .wehdah-corner { position: absolute; width: 8px; height: 8px; border-color: #1a3a5c; }
    ...
    /* ------- Meta block ------- */
    .wehdah-meta-title { font-size: 18pt; font-weight: bold; color: #1a3a5c; text-align: right; margin-bottom: 6px; letter-spacing: 1px; }
    ...
    table.wehdah-items th { background: #1a3a5c; color: #ffffff; padding: 6px 5px; font-size: 8.5pt; text-align: left; }
    ...
    /* ------- Totals ------- */
    .wehdah-amount-words { font-weight: bold; font-size: 8.5pt; margin: 8px 0; padding: 6px 10px; background: #f0f4f8; border: 1px solid #c0d0e0; }
    .wehdah-totals { margin-left: auto; width: 50%; border-collapse: collapse; }
    .wehdah-totals td { padding: 4px 8px; font-size: 9.5pt; }
    .wehdah-totals .wehdah-grand-label { font-weight: bold; font-size: 10pt; background: #1a3a5c; color: #ffffff; }
    .wehdah-totals .wehdah-grand-val { font-weight: bold; font-size: 12pt; border: 2px solid #1a3a5c; text-align: right; }

    /* ------- Bank ------- */
    .wehdah-bank { font-size: 8.5pt; margin: 8px 0; padding: 6px 10px; border: 1px solid #c0d0e0; background: #fafcff; }
    .wehdah-bank-label { font-weight: bold; color: #1a3a5c; margin-right: 8px; }
    .wehdah-bank-line { font-weight: 600; }
    .wehdah-bank-sep { color: #888; }

    /* ------- Terms / footer text ------- */
    .wehdah-terms { font-size: 8pt; margin: 8px 0 4px; line-height: 1.4; }
    .wehdah-terms strong { color: #1a3a5c; }
    ...
    /* ------- Artwork ------- */
    .wehdah-artwork-bar { background: #e8edf3; color: #1a3a5c; padding: 8px 12px; margin-bottom: 12px; display: table; width: 100%; }
