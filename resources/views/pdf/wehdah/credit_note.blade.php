...
<head>
    <meta charset="utf-8">
    <title>{{ $document->official_number ?? 'CREDIT NOTE' }}</title>
...
@foreach($itemPages as $pageIndex => $pageItems)
    ...
    @if($pageIndex === 0)
        @include('pdf.wehdah._header', ['variant' => 'full', 'documentTitle' => 'CREDIT NOTE'])
        <div class="ws-meta-row">
            <div class="ws-meta-col ws-meta-col-left">
                @include('pdf.wehdah._bill-to', ['label' => 'Credit To:'])
            </div>
            <div class="ws-meta-col ws-meta-col-right">
                @include('pdf.wehdah._meta-block', ['documentTitleEn' => 'CREDIT NOTE', 'showValidity' => false])
            </div>
        </div>
        ...
        @endif
    @else
        @include('pdf.wehdah._header', ['variant' => 'compact', 'documentTitle' => 'CREDIT NOTE'])
    @endif
    ...
    <table class="ws-items">
        <thead>
            <tr>
                ...
                <th class="ws-col-total">Credit Amount</th>
            </tr>
        </thead>
        <tbody>
    ...
    @else
        <div class="ws-totals-row">
            ...
            <div class="ws-totals-grand-cell">
                ...
                <table class="ws-grand-table">
                    <tr>
                        <td class="ws-grand-label">Total Credit ({{ $document->currency }})</td>
        ...
        @include('pdf.wehdah._signature', [
            ...
            'rightIntro' => $boilerplate['signature_right_intro'] ?? 'Credit acknowledged by',
...
@include('pdf.partials.artwork-pages', ['documentTitleEn' => 'CREDIT NOTE', 'showConfirmation' => true])
</body>
</html>
